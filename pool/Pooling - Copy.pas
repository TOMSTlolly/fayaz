...
type
  ...
  private
    ...
    fkPool : TkbmMemTable;
    procedure CreateTablePool(AKt: TkbmMemTable);
  protected
  public
...
procedure TObjectPool.CreateTablePool(AKt : TkbmMemTable);
begin
   ...
   begin
     ...
     Add('IsFree'     , ftBoolean  , 0 , false);
   end;
   AKt.CreateTable;
   AKt.AddIndex('free_idx','isFree;id',[]);
   AKt.IndexName := ''; //'free_idx';
end;
...
begin
  ...
  fkPool := TkbmMemTable.Create(nil);
  CreateTablePool(fkPool);
end;
